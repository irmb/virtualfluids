...
private:
    ...
    void fineToCoarse(int level, InterpolationCells* icellFC, ICellNeigh &offFC, CudaStreamIndex streamIndex);
    void coarseToFine(int level, InterpolationCells* icellCF, ICellNeigh &offCF, CudaStreamIndex streamIndex);
