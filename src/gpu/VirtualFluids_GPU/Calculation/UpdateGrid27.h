...
private:
    ...
    void fineToCoarse(int level, InterpolationCell* icellFC, ICellNeigh &offFC, CudaStreamIndex streamIndex);
    void coarseToFine(int level, InterpolationCell* icellCF, ICellNeigh &offCF, CudaStreamIndex streamIndex);
