...
private:
    ...
    void fineToCoarse(int level, InterpolationCellFineToCoarse* icellFC, ICellNeigh &offFC, CudaStreamIndex streamIndex);
    void coarseToFine(int level, InterpolationCellCoarseToFine* icellCF, ICellNeigh &offCF, CudaStreamIndex streamIndex);
