...
#ifndef INTERPOLATE_STATIC_TO_ROTATING_INLINES
#define INTERPOLATE_STATIC_TO_ROTATING_INLINES
...
__inline__ __host__ __device__ void rotateSecondOrderMomentsRotatingToGlobal(real &m011, real &m101, real &m110,
                                                                             ...
                                                                             real angleY, real angleZ)
{
    ...
    if (angleX != c0o1) {
        mxxMyyRotated = c1o2 * (mxxMyy + mxxMzz + (mxxMyy - mxxMzz) * cos(angleX * c2o1) + c2o1 * m011 * sin(angleX * c2o1));
        mxxMzzRotated =
            c1o2 * (mxxMyy + mxxMzz + (-mxxMyy + mxxMzz) * cos(angleX * c2o1) - c2o1 * m011 * sin(angleX * c2o1));
        ...
        mxxMyyRotated = mxxMyy - c1o2 * mxxMzz + c1o2 * mxxMzz * cos(angleY * c2o1) + m101 * sin(angleY * c2o1);
