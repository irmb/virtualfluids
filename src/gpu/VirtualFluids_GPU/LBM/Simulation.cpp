...
{
	TurbulenceModelFactory tmFactory = TurbulenceModelFactory(para);
...
void Simulation::init(GridProvider &gridProvider, BoundaryConditionFactory *bcFactory, TurbulenceModelFactory *tmFactory)
{
