...
public:
    ...
    virtual void getStressValues(real *normalX, real *normalY, real *normalZ, real* vx, real* vy, real* vz, int *indices, int* samplingIndices, int*        samplingOffsets, real* z0, int level) const = 0;
