...
void LevelGridBuilder::getStressValues(real* normalX, real* normalY, real* normalZ, int* indices, int* samplingIndices, int* samplingOffset, real* z0, int level) const
{
