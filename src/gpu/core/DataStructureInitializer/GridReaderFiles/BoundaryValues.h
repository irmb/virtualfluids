...
private:
    ...
    void initalVectors(uint maxColumn);
    void readData(uint level, int index, uint maxColumn);
    void resizeVectorsPerLevel(uint level, uint maxColumn);
    void skipLine();
    void readLevelSize(uint level);
