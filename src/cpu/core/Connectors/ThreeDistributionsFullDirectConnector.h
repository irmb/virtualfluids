...
#ifndef ThreeDistributionsFullDirectConnector_H
#define ThreeDistributionsFullDirectConnector_H
...
private:
    ...
    CbArray4D<real, IndexerX4X3X2X1>::CbArray4DPtr h2SplitAFrom;
    CbArray4D<real, IndexerX4X3X2X1>::CbArray4DPtr h2SplitBFrom;
    CbArray3D<real, IndexerX3X2X1>::CbArray3DPtr   h2Split0From;

    CbArray4D<real, IndexerX4X3X2X1>::CbArray4DPtr h2SplitATo;
    CbArray4D<real, IndexerX4X3X2X1>::CbArray4DPtr h2SplitBTo;
    CbArray3D<real, IndexerX3X2X1>::CbArray3DPtr   h2Split0To;

    SPtr<EsoTwist3D> fFrom, hFrom, h2From;
    SPtr<EsoTwist3D> fTo, hTo, h2To;
};
//////////////////////////////////////////////////////////////////////////
inline void ThreeDistributionsFullDirectConnector::updatePointers()
{
    ...
    h2SplitAFrom = dynamicPointerCast<EsoSplit>(this->h2From)->getSplitA();
    h2SplitBFrom = dynamicPointerCast<EsoSplit>(this->h2From)->getSplitB();
    h2Split0From = dynamicPointerCast<EsoSplit>(this->h2From)->getSplit0();

    h2SplitATo = dynamicPointerCast<EsoSplit>(this->h2To)->getSplitA();
    h2SplitBTo = dynamicPointerCast<EsoSplit>(this->h2To)->getSplitB();
    h2Split0To = dynamicPointerCast<EsoSplit>(this->h2To)->getSplit0();
}
//////////////////////////////////////////////////////////////////////////
inline void ThreeDistributionsFullDirectConnector::exchangeData(int x1From, int x2From, int x3From, int x1To, int x2To, int x3To)
{
    ...
    (*this->h2SplitATo)(eP00, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(eP00, x1From, x2From, x3From);
    (*this->h2SplitATo)(e0P0, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(e0P0, x1From, x2From, x3From);
    (*this->h2SplitATo)(e00P, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(e00P, x1From, x2From, x3From);
    (*this->h2SplitATo)(ePP0, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(ePP0, x1From, x2From, x3From);
    (*this->h2SplitATo)(eMP0, x1To + 1, x2To, x3To) =
        (*this->h2SplitAFrom)(eMP0, x1From + 1, x2From, x3From);
    (*this->h2SplitATo)(eP0P, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(eP0P, x1From, x2From, x3From);
    (*this->h2SplitATo)(eM0P, x1To + 1, x2To, x3To) =
        (*this->h2SplitAFrom)(eM0P, x1From + 1, x2From, x3From);
    (*this->h2SplitATo)(e0PP, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(e0PP, x1From, x2From, x3From);
    (*this->h2SplitATo)(e0MP, x1To, x2To + 1, x3To) =
        (*this->h2SplitAFrom)(e0MP, x1From, x2From + 1, x3From);
    (*this->h2SplitATo)(ePPP, x1To, x2To, x3To) =
        (*this->h2SplitAFrom)(ePPP, x1From, x2From, x3From);
    (*this->h2SplitATo)(eMPP, x1To + 1, x2To, x3To) =
        (*this->h2SplitAFrom)(eMPP, x1From + 1, x2From, x3From);
    (*this->h2SplitATo)(ePMP, x1To, x2To + 1, x3To) =
        (*this->h2SplitAFrom)(ePMP, x1From, x2From + 1, x3From);
    (*this->h2SplitATo)(eMMP, x1To + 1, x2To + 1, x3To) =
        (*this->h2SplitAFrom)(eMMP, x1From + 1, x2From + 1, x3From);

    (*this->h2SplitBTo)(eM00, x1To + 1, x2To, x3To) =
        (*this->h2SplitBFrom)(eM00, x1From + 1, x2From, x3From);
    (*this->h2SplitBTo)(e0M0, x1To, x2To + 1, x3To) =
        (*this->h2SplitBFrom)(e0M0, x1From, x2From + 1, x3From);
    (*this->h2SplitBTo)(e00M, x1To, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(e00M, x1From, x2From, x3From + 1);
    (*this->h2SplitBTo)(eMM0, x1To + 1, x2To + 1, x3To) =
        (*this->h2SplitBFrom)(eMM0, x1From + 1, x2From + 1, x3From);
    (*this->h2SplitBTo)(ePM0, x1To, x2To + 1, x3To) =
        (*this->h2SplitBFrom)(ePM0, x1From, x2From + 1, x3From);
    (*this->h2SplitBTo)(eM0M, x1To + 1, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(eM0M, x1From + 1, x2From, x3From + 1);
    (*this->h2SplitBTo)(eP0M, x1To, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(eP0M, x1From, x2From, x3From + 1);
    (*this->h2SplitBTo)(e0MM, x1To, x2To + 1, x3To + 1) =
        (*this->h2SplitBFrom)(e0MM, x1From, x2From + 1, x3From + 1);
    (*this->h2SplitBTo)(e0PM, x1To, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(e0PM, x1From, x2From, x3From + 1);
    (*this->h2SplitBTo)(eMMM, x1To + 1, x2To + 1, x3To + 1) =
        (*this->h2SplitBFrom)(eMMM, x1From + 1, x2From + 1, x3From + 1);
    (*this->h2SplitBTo)(ePMM, x1To, x2To + 1, x3To + 1) =
        (*this->h2SplitBFrom)(ePMM, x1From, x2From + 1, x3From + 1);
    (*this->h2SplitBTo)(eMPM, x1To + 1, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(eMPM, x1From + 1, x2From, x3From + 1);
    (*this->h2SplitBTo)(ePPM, x1To, x2To, x3To + 1) =
        (*this->h2SplitBFrom)(ePPM, x1From, x2From, x3From + 1);

    (*this->h2Split0To)(x1To, x2To, x3To) = (*this->h2Split0From)(x1From, x2From, x3From);
}
#endif
//! \}
