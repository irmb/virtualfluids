 ...
 //   using namespace UbMath;
    ...
    switch (direction) {
        case dP00:
            ...
            //           (BCVeloWeight)  ;
            //f[dPP0] = (ftemp[dPP0] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPP0]) *
            //            (1 - BCVeloWeight) +
            //        (ftemp[dMM0] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMM0] +
            //         velocity * (6) * WEIGTH[dPP0] /*bcPtr->getBoundaryVelocity(INVDIR[dMM0])*/) *
            //            (BCVeloWeight); 
            //f[dPM0] = (ftemp[dPM0] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPM0]) *
            //            (1 - BCVeloWeight) +
            //        (ftemp[dMP0] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMP0] +
            //        velocity*(6)*WEIGTH[dPP0]/* bcPtr->getBoundaryVelocity(INVDIR[dMP0])*/) *
            //            (BCVeloWeight); 
            //f[dP0P] = (ftemp[dP0P] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dP0P]) *
            //            (1 - BCVeloWeight) +
            //        (ftemp[dM0M] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dM0M] +
            //        velocity*(6)*WEIGTH[dP0P]/* bcPtr->getBoundaryVelocity(INVDIR[dM0M])*/) *
            //            (BCVeloWeight); 
            //f[dP0M] = (ftemp[dP0M] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dP0M])*
            //            (1 - BCVeloWeight) +
            //        (ftemp[dM0P] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dM0P] +
            //        velocity*(6)*WEIGTH[dP0M]/* bcPtr->getBoundaryVelocity(INVDIR[dM0P])*/) *
            //            (BCVeloWeight); 
            //f[dPPP] = (ftemp[dPPP] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPPP])*
            //            (1 - BCVeloWeight) +
            //        (ftemp[dMMM] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMMM] +
            //     velocity * (6) * WEIGTH[dPPP] /* bcPtr->getBoundaryVelocity(INVDIR[dMMM])*/) *
            //            (BCVeloWeight); 
            //f[dPMP] = (ftemp[dPMP] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPMP]) *
            //             (1 - BCVeloWeight) +
            //         (ftemp[dMPM] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMPM] +
            //     velocity * (6) * WEIGTH[dPPP] /*bcPtr->getBoundaryVelocity(INVDIR[dMPM])*/) *
            //             (BCVeloWeight); 
            //f[dPPM] = (ftemp[dPPM] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPPM]) *
            //             (1 - BCVeloWeight) +
            //         (ftemp[dMMP] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMMP] +
            //     velocity * (6) * WEIGTH[dPPP] /* bcPtr->getBoundaryVelocity(INVDIR[dMMP])*/) *
            //             (BCVeloWeight); 
            //f[dPMM] = (ftemp[dPMM] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dPMM]) *
            //             (1 - BCVeloWeight) +
            //         (ftemp[dMPP] * (one_over_sqrt3 + vx1) + (1.0 - one_over_sqrt3 - vx1) * f[dMPP] +
