...
//
//! \file GbGeneralThirdOrderImplicitSurface.h
//! \ingroup geometry3d
...
class GbGeneralThirdOrderImplicitSurface;
using GbGeneralThirdOrderImplicitSurfacePtr = SPtr<GbGeneralThirdOrderImplicitSurface>;


class GbGeneralThirdOrderImplicitSurface : public GbObject3D, public UbObserver
{
public:
	GbGeneralThirdOrderImplicitSurface();
	GbGeneralThirdOrderImplicitSurface(const double& x1a, const double& x2a, const double& x3a, const double& x1b, const double& x2b, const double& x3b, const double& edgeLength, const double& dx, const double& thickness=0);

	GbGeneralThirdOrderImplicitSurface(const double & x1a, const double & x2a, const double & x3a, const double & x1b, const double & x2b, const double & x3b, const double & x1c, const double & x2c, const double & x3c, const double & x1d, const double & x2d, const double & x3d, const double & edgeLength, const double & dx);
	//GbGeneralThirdOrderImplicitSurface(const double& minX1, const double& minX2, const double& minX3, const double& maxX1, const double& maxX2, const double& maxX3);
	GbGeneralThirdOrderImplicitSurface(GbGeneralThirdOrderImplicitSurface *imp);
	~GbGeneralThirdOrderImplicitSurface();

	GbGeneralThirdOrderImplicitSurface* clone() override { return new GbGeneralThirdOrderImplicitSurface(this); }
	...
	//GbGeneralThirdOrderImplicitSurface* createClippedRectangle3D(const double& x1a,const double& x2a,const double& x3a,const double& x1b,const double& x2b,const double& x3b);
