...
void GridReader::allocArrays_BoundaryValues()
{
	...
	if (para->getConcFile()) {
		...
		for (int i = 0; i <= maxLevel; i++) {
			...
			if (temp > 0)
			{
				...
				for (int j = 0; j < temp; j++)
					para->getParH(i)->concentration[j] = (real)1.0;
				////////////////////////////////////////////////////////////////////////////
	 ...
	 //--------------------------------------------------------------------------//
	if (para->isStreetVelocityFile()) {
		BoundaryValues *obj_StreetVector = new BoundaryValues(para->getStreetVelocityFilePath());
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//streetVector
		for (int i = 0; i <= maxLevel; i++) {
			int temp = obj_StreetVector->getSize(i);
			cout << "size street vector, at Level " << i << "and at Rank :" << para->getMyID() << " = " << temp << endl;
			////////////////////////////////////////////////////////////////////////////
			para->getParH(i)->numberOfStreetNodes = temp;
			para->getParD(i)->numberOfStreetNodes = temp;
			if (temp > 0)
			{
				cout << "in if of street velocity fractions at Rank:" << para->getMyID() << endl;
				////////////////////////////////////////////////////////////////////////////
				para->cudaAllocStreetVelocityFractions(i);
				////////////////////////////////////////////////////////////////////////////
				//set X and Y fraction of street velocity
				obj_StreetVector->setStreetVelocityFractions(para->getParH(i)->streetFractionXvelocity, para->getParH(i)->streetFractionYvelocity, i);
				////////////////////////////////////////////////////////////////////////////
				//naschVelocity
				for (int j = 0; j < temp; j++)
					para->getParH(i)->naschVelocity[j] = (int)-1;
				////////////////////////////////////////////////////////////////////////////
				para->cudaCopyStreetVelocityFractions(i);
				////////////////////////////////////////////////////////////////////////////
			}
		}
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		delete obj_StreetVector;
	}//end street velocity fractions
