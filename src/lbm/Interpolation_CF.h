...
__host__ __device__ __inline__ void interpolate_cf(const real& x, const real& y, const real& z, real* const f, Coefficients &coefficients, const real& eps_new, const real& omegaF)
{
...
__host__ __device__ __inline__ void interpolate_cf(
