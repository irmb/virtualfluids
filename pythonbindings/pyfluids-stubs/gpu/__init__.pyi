...
from pyfluids import basics, parallel
...
class HubConfig:
    ...
    number_of_points_per_turbine: int
    def __init__(
        self,
        length: float,
        radius: float,
...
class VAWTConfig:
    rotor_height: float
    flag_localized_smearing_width: bool
    def __init__(
            self, 
            rotor_height: float, 
            flag_localized_smearing_width: bool) -> None: ...
...
class ActuatorFarm(PreCollisionInteractor):
    def __init__(
        ...
        tower_config: Optional[TowerConfig] = ...,
        vawt_config: Optional[VAWTConfig] = ...,
    ) -> None: ...
    def update_forces_and_coordinates(self, time: float, deltaT: float) -> None: ...
    ...
    def get_all_hub_coords_x_device(self) -> int: ...
    def get_all_hub_coords_y_device(self) -> int: ...
    def get_all_hub_coords_z_device(self) -> int: ...
    def get_all_hub_velocities_x_device(self) -> int: ...
    def get_all_hub_velocities_y_device(self) -> int: ...
    def get_all_hub_velocities_z_device(self) -> int: ...
    def get_all_hub_forces_x_device(self) -> int: ...
    def get_all_hub_forces_y_device(self) -> int: ...
    def get_all_hub_forces_z_device(self) -> int: ...
    def get_all_tower_coords_x_device(self) -> int: ...
    def get_all_tower_coords_y_device(self) -> int: ...
    def get_all_tower_coords_z_device(self) -> int: ...
    def get_all_tower_velocities_x_device(self) -> int: ...
    def get_all_tower_velocities_y_device(self) -> int: ...
    def get_all_tower_velocities_z_device(self) -> int: ...
    def get_all_tower_forces_x_device(self) -> int: ...
    def get_all_tower_forces_y_device(self) -> int: ...
    def get_all_tower_forces_z_device(self) -> int: ...
    #
    ...
    @property
    def number_of_blade_points(self) -> int: ...
    @property
    def number_of_blade_points_per_turbine(self) -> int: ...
    @property
    def number_of_points_per_blade(self) -> int: ...
    @property
    def number_of_turbines(self) -> int: ...
    # Hub and Tower properties
    @property
    def total_number_of_points(self) -> int: ...
    @property
    def number_of_hub_points(self) -> int: ...
    @property
    def number_of_tower_points(self) -> int: ...
...
class ActuatorFarmStandalone(ActuatorFarm):
    def __init__(
        ...
        cuda_memory_manager: CudaMemoryManager,
        diameter: float,
        number_of_points_per_blade: int,
        turbine_positions_x: npt.NDArray[np.float32],
        turbine_positions_y: npt.NDArray[np.float32],
        turbine_positions_z: npt.NDArray[np.float32],
        ...
        hub_config: Optional[HubConfig] = ...,
        tower_config: Optional[TowerConfig] = ...,
        hub_drag_coeff: Optional[float] = ...,
        hub_skin_friction_coeff: Optional[float] = ...,
        tower_drag_coeff: Optional[float] = ...,
        number_of_blades: int = ...,
        blade_normal_coefficients: list[float] | None = ...,
    ) -> None: ...

class PlantAreaDensityFunction(Enum):
    Flat = ...
    BottomHeavy = ...
    TopHeavy = ...

class Forest(PreCollisionInteractor):
    def __init__( 
        self,
        para: Parameter,
        cuda_memory_manager: CudaMemoryManager,
...
class BoundaryConditionFactory:
    ...
    def set_surface_layer_bounday_condition(self, stress_boundary_condition_type: StressBC, surface_layer_boundary_condition_type: SurfaceLayerBC) -> None: ...
...
class PrecursorBC:
    __members__: ClassVar[dict] = ...  # read-only
    PrecursorDistributions: ClassVar[PrecursorBC] = ...
...
class Simulation:
    ...
    def calculate_timestep(self, timestep: int) -> None: ...
...
class StressBC:
    ...
    StressBounceBackWithPressureCompressible: ClassVar[StressBC] = ...
    StressInterpolatedCompressible: ClassVar[StressBC] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
class SurfaceLayerBC:
    NotSpecified: ClassVar[SurfaceLayerBC] = ...
    SurfaceHeatFlux: ClassVar[SurfaceLayerBC] = ...
    SurfaceTemperature: ClassVar[SurfaceLayerBC] = ...
...
def create_file_collection(path: str, prefix: str, type: TransientBCFileType) -> FileCollection: ...
