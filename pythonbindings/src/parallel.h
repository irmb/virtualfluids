...
namespace parallel_bindings
{
namespace py = pybind11;

inline void makeModule(py::module_ &pyfluids)
{
    auto parallel = pyfluids.def_submodule("parallel");
    py::class_<vf::parallel::Communicator, std::shared_ptr<vf::parallel::Communicator>>(parallel, "Communicator")
    ...
    py::class_<vf::parallel::MPICommunicator, vf::parallel::Communicator, std::shared_ptr<vf::parallel::MPICommunicator>>(parallel, "MPICommunicator")
