...
namespace lbm_bindings
{
    ...
    {
        auto lbm = pyfluids.def_submodule("lbm");
        py::enum_<vf::lbm::TurbulenceModel>(lbm, "TurbulenceModel")
        ...
        py::enum_<vf::lbm::advection_diffusion::TurbulenceModel>(lbm, "TurbulenceModelAdvectionDiffusion")
