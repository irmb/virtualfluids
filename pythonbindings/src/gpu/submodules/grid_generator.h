...
namespace gpu_bindings::grid_generator
{
    ...
    {  
        ...
        .def("set_stress_boundary_condition", &LevelGridBuilder::setStressBoundaryCondition, py::arg("side_type"), py::arg("normal_x"), py::arg("normal_y"), py::arg("normal_z"), py::arg("sampling_offset"), py::arg("von_karman_constant"), py::arg("roughness_length"), py::arg("delta_x"), py::arg("roughness_map")=nullptr)
        ...
        .def("set_precursor_boundary_condition", &LevelGridBuilder::setPrecursorBoundaryCondition, py::arg("side_type"), py::arg("file_collection"), py::arg("time_steps_between_reads"), py::arg("cycle_files"), py::arg("velocity_x") = c0o1, py::arg("velocity_y") = c0o1, py::arg("velocity_z") = c0o1, py::arg("file_level_to_grid_level_map"))
        ...
        .def("set_stress_boundary_condition", &MultipleGridBuilderFacade::setStressBoundaryCondition, py::arg("side_type"), py::arg("normal_x"), py::arg("normal_y"), py::arg("normal_z"), py::arg("sampling_offset"), py::arg("von_karman_constant"), py::arg("roughness_length"), py::arg("delta_x"), py::arg("roughness_map")=nullptr)
        .def("set_precursor_boundary_condition", &MultipleGridBuilderFacade::setPrecursorBoundaryCondition, py::arg("side_type"), py::arg("file_collection"),
                                                                    py::arg("time_steps_between_reads"), py::arg("cycle_files"), py::arg("velocity_x") = vf::basics::constant::c0o1,
                                                                    py::arg("velocity_y") = vf::basics::constant::c0o1, py::arg("velocity_z") = vf::basics::constant::c0o1,
                                                                    py::arg("file_level_to_grid_level_map")=std::vector<uint>() )
