...
REFERENCE_DATA_DIR=regression_tests/gpu/ActuatorLineDisk

# 2. set cmake flags for the build of VirtualFluids
CMAKE_FLAGS="--preset=make_gpu -DCMAKE_CUDA_ARCHITECTURES=75"

# 3. define the application to be executed
APPLICATION="./build/bin/ActuatorLineDisk ./apps/gpu/ActuatorLineDisk/actuatorlinedisk.cfg"

# 4. set the path to the produced data
RESULT_DATA_DIR=output/ActuatorLineDisk/
